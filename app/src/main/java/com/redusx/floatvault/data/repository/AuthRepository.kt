...
class AuthRepository @Inject constructor(
    ...
    companion object {
        private const val PREFS_NAME = "floatvault_auth_prefs"
        private const val LEGACY_PREFS_NAME = "datamanager_auth_prefs"
    ...
    private fun createEncryptedPrefs(): SharedPreferences {
        return try {
            ...
            // Migrate legacy preferences if new prefs doesn't have PIN hash yet
            if (!newPrefs.contains(KEY_PIN_HASH)) {
                try {
                    ...
                    if (legacyPrefs.contains(KEY_PIN_HASH)) {
